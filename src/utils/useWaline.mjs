const e = ["nick", "mail", "link"], t = t => t.filter((t => e.includes(t))), n = e => new Promise(((t, n) => {
...
const y = {
      ...
      "ru-ru": v,
      "ru-RU": v
    }, w = {"Content-Type": "application/json"}, b = (e, t = "") => {
      ...
      return e
              ...
              type: r,
              signal: i
            }) => fetch(`${e}/article?path=${encodeURIComponent(n.join(","))}&type=${encodeURIComponent(r.join(","))}&lang=${t}`, {signal: i}).then((e => e.json())),
    x = ({serverURL: e, lang: t, path: n, type: r, action: i}) => fetch(`${e}/article?lang=${t}`, {
      method: "POST",
      headers: w,
      body: JSON.stringify({path: n, type: r, action: i})
    }).then((e => e.json())),
    _ = ({serverURL: e, lang: t, token: n, objectId: r, ...i}) => fetch(`${e}/comment/${r}?lang=${t}`, {
      method: "PUT",
      headers: {...w, Authorization: `Bearer ${n}`},
      body: JSON.stringify(i)
    }).then((e => e.json())).then((e => b(e, "Update comment"))), C = e => {
      try {
        e = decodeURI(e)
      } catch (e) {
      }
      return e
    }, S = (e = "") => e.replace(/\/$/u, ""), $ = e => /^(https?:)?\/\//.test(e), I = e => {
      const t = S(e);
      return $(t) ? t : `https://${t}`
    }, E = e => Array.isArray(e) ? e : !!e && [0, e], R = (e, t) => "function" == typeof e ? e : !1 !== e && t,
    ...
    A = (e, t) => {
      ...
      const r = "string" == typeof e ? new Date(-1 !== e.indexOf(" ") ? e.replace(/-/g, "/") : e) : e,
          i = t.getTime() - r.getTime(), l = Math.floor(i / 864e5);
      if (0 === l) {
        const e = i % 864e5, t = Math.floor(e / 36e5);
        if (0 === t) {
          const t = e % 36e5, r = Math.floor(t / 6e4);
          if (0 === r) {
            const e = t % 6e4;
      ...
      return l < 0 ? n.now : l < 8 ? `${l} ${n.days}` : (e => {
        const t = A(e.getDate(), 2), n = A(e.getMonth() + 1, 2);
...
const H = e => ae(e) ? e : null == e ? "" : re(e) || ue(e) && (e.toString === de || !se(e.toString)) ? JSON.stringify(e, W, 2) : String(e),
    W = (e, t) => t && t.__v_isRef ? W(e, t.value) : ie(t) ? {[`Map(${t.size})`]: [...t.entries()].reduce(((e, [t, n]) => (e[`${t} =>`] = n, e)), {})} : le(t) ? {[`Set(${t.size})`]: [...t.values()]} : !ue(t) || re(t) || fe(t) ? t : String(t),
    q = {}, Z = [], G = () => {
    }, K = () => !1, Q = /^on[^a-z]/, J = e => Q.test(e), Y = e => e.startsWith("onUpdate:"), X = Object.assign,
    ee = (e, t) => {
      const n = e.indexOf(t);
      n > -1 && e.splice(n, 1)
    }, te = Object.prototype.hasOwnProperty, ne = (e, t) => te.call(e, t), re = Array.isArray,
    ie = e => "[object Map]" === he(e), le = e => "[object Set]" === he(e), oe = e => "[object Date]" === he(e),
    se = e => "function" == typeof e, ae = e => "string" == typeof e, ce = e => "symbol" == typeof e,
    ue = e => null !== e && "object" == typeof e, pe = e => ue(e) && se(e.then) && se(e.catch),
    de = Object.prototype.toString, he = e => de.call(e), fe = e => "[object Object]" === he(e),
    ...
    }, ye = /-(\w)/g, we = ve((e => e.replace(ye, ((e, t) => t ? t.toUpperCase() : "")))), be = /\B([A-Z])/g,
    ke = ve((e => e.replace(be, "-$1").toLowerCase())), xe = ve((e => e.charAt(0).toUpperCase() + e.slice(1))),
    _e = ve((e => e ? `on${xe(e)}` : "")), Ce = (e, t) => !Object.is(e, t), Se = (e, t) => {
...
}, ze = e => (e.w & Pe) > 0, Oe = e => (e.n & Pe) > 0, je = new WeakMap;
let Te = 0, Pe = 1;
let Ue;
const Me = Symbol(""), Ne = Symbol("");

class Fe {
  constructor(e, t = null, n) {
    this.fn = e, this.scheduler = t, this.active = !0, this.deps = [], this.parent = void 0, function (e, t = Re) {
  ...
  run() {
    ...
    try {
      return this.parent = Ue, Ue = this, Ve = !0, Pe = 1 << ++Te, Te <= 30 ? (({deps: e}) => {
...
function lt(e = !1) {
  return function (t, n, r, i) {
    ...
    const o = re(t) && ge(n) ? Number(n) < t.length : ne(t, n), s = Reflect.set(t, n, r, i);
    return t === Vt(i) && (o ? Ce(r, l) && Ge(t, "set", n, r) : Ge(t, "add", n, r)), s
  }
}

const ot = {
      get: Xe, set: lt(), deleteProperty: function (e, t) {
        const n = ne(e, t), r = Reflect.deleteProperty(e, t);
    ...
    }, st = {get: tt, set: (e, t) => !0, deleteProperty: (e, t) => !0}, at = X({}, ot, {get: et, set: lt(!0)}), ct = e => e,
    ut = e => Reflect.getPrototypeOf(e);

function pt(e, t, n = !1, r = !1) {
  const i = Vt(e = e.__v_raw), l = Vt(t);
  n || (t !== l && qe(i, 0, t), qe(i, 0, l));
  const {has: o} = ut(i), s = r ? ct : n ? Wt : Ht;
  return o.call(i, t) ? s(e.get(t)) : o.call(i, l) ? s(e.get(l)) : void (e !== i && e.get(t))
}

function dt(e, t = !1) {
  const n = this.__v_raw, r = Vt(n), i = Vt(e);
...
function gt(e, t) {
  t = Vt(t);
  const n = Vt(this), {has: r, get: i} = ut(n);
  let l = r.call(n, e);
...
function mt(e) {
  const t = Vt(this), {has: n, get: r} = ut(t);
  let i = n.call(t, e);
...
function vt() {
  const e = Vt(this), t = 0 !== e.size, n = e.clear();
  return t && Ge(e, "clear", void 0, void 0), n
}

function yt(e, t) {
  return function (n, r) {
    const i = this, l = i.__v_raw, o = Vt(l), s = t ? ct : e ? Wt : Ht;
...
function wt(e, t, n) {
  return function (...r) {
    const i = this.__v_raw, l = Vt(i), o = ie(l), s = "entries" === e || e === Symbol.iterator && o,
        a = "keys" === e && o, c = i[e](...r), u = n ? ct : t ? Wt : Ht;
...
function kt() {
  const e = {
    get(e) {
      ...
      return ht(this)
    }, has: dt, add: ft, set: gt, delete: mt, clear: vt, forEach: yt(!1, !1)
  }, t = {
    get(e) {
      return pt(this, e, !1, !0)
    }, get size() {
      return ht(this)
    }, has: dt, add: ft, set: gt, delete: mt, clear: vt, forEach: yt(!1, !0)
  }, n = {
    get(e) {
      return pt(this, e, !0)
    }, get size() {
    ...
    }, add: bt("add"), set: bt("set"), delete: bt("delete"), clear: bt("clear"), forEach: yt(!0, !1)
  }, r = {
    get(e) {
      ...
      return dt.call(this, e, !0)
    }, add: bt("add"), set: bt("set"), delete: bt("delete"), clear: bt("clear"), forEach: yt(!0, !0)
  };
...
const It = {get: $t(!1, !1)}, Et = {get: $t(!1, !0)}, Rt = {get: $t(!0, !1)}, Lt = new WeakMap, At = new WeakMap,
    zt = new WeakMap, Ot = new WeakMap;
...
const Ht = e => ue(e) ? Tt(e) : e, Wt = e => ue(e) ? Pt(e) : e;
...
const en = {
  get: (e, t, n) => Xt(Reflect.get(e, t, n)), set: (e, t, n, r) => {
    const i = e[t];
...
const xn = e => null == e.id ? 1 / 0 : e.id, _n = (e, t) => {
  const n = xn(e) - xn(t);
  if (0 === n) {
...
function Sn(e, t, ...n) {
  ...
  if (o && o in r) {
    const e = `${"modelValue" === o ? "model" : o}Modifiers`, {number: t, trim: l} = r[e] || q;
    l && (i = n.map((e => ae(e) ? e.trim() : e))), t && (i = n.map(Ie))
  }
  let s, a = r[s = _e(t)] || r[s = _e(we(t))];
...
function An(e) {
  ...
  try {
    if (4 & n.shapeFlag) {
      ...
      const e = t;
      m = qr(e.length > 1 ? e(l, {attrs: a, slots: s, emit: c}) : e(l, null)), v = t.props ? a : zn(a)
    }
  } catch (t) {
  ...
  let w = m;
  if (v && !1 !== g) {
    const e = Object.keys(v), {shapeFlag: t} = w;
...
function Nn(e, t, {immediate: n, deep: r, flush: i, onTrack: l, onTrigger: o} = q) {
  const s = Yr;
  let a, c, u = !1, p = !1;
...
const Bn = e => (t, n = Yr) => (!ni || "sp" === e) && function (e, t, n = Yr, r = !1) {
  if (n) {
...
}(e, ((...e) => t(...e)), n), Hn = Bn("m"), Wn = Bn("bum"), qn = Bn("um");

function Zn(e, t) {
  const n = En;
  if (null === n) return e;
  const r = li(n) || n.proxy, i = e.dirs || (e.dirs = []);
  for (let e = 0; e < t.length; e++) {
    let [n, l, o, s = q] = t[e];
    n && (se(n) && (n = {mounted: n, updated: n}), n.deep && Fn(l), i.push({
      dir: n,
      instance: r,
      value: l,
      oldValue: void 0,
...
function Yn(e, t, n, r) {
  ...
  } else if (ue(e)) if (e[Symbol.iterator]) i = Array.from(e, ((e, n) => t(e, n, void 0, l && l[n]))); else {
...
const Xn = e => e ? ti(e) ? li(e) || e.proxy : Xn(e.parent) : null, er = X(Object.create(null), {
  $: e => e,
  $el: e => e.vnode.el,
  $data: e => e.data,
  $props: e => e.props,
  ...
  $watch: e => G
}), tr = (e, t) => e !== q && !e.__isScriptSetup && ne(e, t), nr = {
  get({_: e}, t) {
    const {ctx: n, setupState: r, data: i, props: l, accessCache: o, type: s, appContext: a} = e;
    let c;
    if ("$" !== t[0]) {
      const s = o[t];
  ...
  }, has({_: {data: e, setupState: t, accessCache: n, ctx: r, appContext: i, propsOptions: l}}, o) {
    let s;
...
function or(e, t, n = !1) {
  ...
  if (re(l)) for (let e = 0; e < l.length; e++) {
    ...
    const t = we(e);
    if (sr(t)) {
      const n = l[e], r = o[t] = re(n) || se(n) ? {type: n} : Object.assign({}, n);
      if (r) {
        const e = ur(Boolean, r.type), n = ur(String, r.type);
...
const pr = e => "_" === e[0] || "$stable" === e, dr = e => re(e) ? e.map(qr) : [qr(e)], hr = (e, t, n) => {
  if (t._n) return t;
  const r = function (e, t = En, n) {
    if (!t) return e;
    if (e._n) return e;
    const r = (...n) => {
      r._d && zr(-1);
...
function yr(e, t) {
  return function (n, r = null) {
    ...
    const s = i.app = {
      ...
      use: (e, ...t) => (l.has(e) || (e && se(e.install) ? (l.add(e), e.install(s, ...t)) : se(e) && (l.add(e), e(s, ...t))), s),
      mixin: e => s,
...
function wr(e, t, n, r, i = !1) {
  ...
  if (Vn(r) && !i) return;
  const l = 4 & r.shapeFlag ? li(r.component) || r.component.proxy : r.el, o = i ? null : l, {i: s, r: a} = e,
      c = t && t.r, u = s.refs === q ? s.refs = {} : s.refs, p = s.setupState;
...
function kr(e) {
  return function (e, t) {
    ...
    const {
        ...
        } = e, f = (e, t, n, r = null, i = null, l = null, o = !1, s = null, a = !!t.dynamicChildren) => {
          if (e === t) return;
          ...
          for (let s = 0; s < t.length; s++) {
            const a = e[s], c = t[s], p = a.el && (a.type === Cr || !Ur(a, c) || 70 & a.shapeFlag) ? u(a.el) : n;
          ...
          const s = e.component = function (e, t, n) {
            const r = e.type, i = (t ? t.appContext : e.appContext) || Qr, l = {
              uid: Jr++,
              vnode: e,
              type: r,
              parent: t,
            ...
            l.ctx = {_: l}, l.root = t ? t.root : l, l.emit = Sn.bind(null, l), e.ce && e.ce(l);
            return l
          }(e, r, i);
          if (e.type.__isKeepAlive && (s.ctx.renderer = H), function (e, t = !1) {
            ni = t;
          ...
          if (function (e, t, n) {
            const {props: r, children: i, component: l} = e, {props: o, children: s, patchFlag: a} = t, c = l.emitsOptions;
          ...
          const s = () => {
            if (e.isMounted) {
              let t, {next: n, bu: r, u: s, parent: a, vnode: c} = e, p = n;
              xr(e, !1), n ? (n.el = c.el, z(e, n, o)) : n = c, r && Se(r), (t = n.props && n.props.onVnodeBeforeUpdate) && Kr(t, a, n, c), xr(e, !0);
              const d = An(e), h = e.subTree;
              e.subTree = d, f(h, d, u(h.el), V(h), e, i, l), n.el = d.el, null === p && function ({
                                                                                                     vnode: e,
                                                                                                     parent: t
                                                                                                   }, n) {
              ...
              let o;
              const {el: s, props: a} = t, {bm: c, m: u, parent: p} = e, d = Vn(t);
          ...
          }, a = e.effect = new Fe(s, (() => yn(c)), e.scope), c = e.update = () => a.run();
          c.id = e.uid, xr(e, !0), c()
        }, z = (e, t, n) => {
          t.component = e;
          const r = e.vnode.props;
          e.vnode = t, e.next = null, function (e, t, n, r) {
            const {props: i, attrs: l, vnode: {patchFlag: o}} = e, s = Vt(i), [a] = e.propsOptions;
            let c = !1;
            if (!(r || o > 0) || 16 & o) {
              let r;
              ir(e, t, i, l) && (c = !0);
              ...
              for (let r = 0; r < n.length; r++) {
                ...
                const u = t[o];
                if (a) if (ne(l, o)) u !== l[o] && (l[o] = u, c = !0); else {
                  const t = we(o);
                  i[t] = lr(a, s, t, u, e, !1)
        ...
        }, O = (e, t, n, r, i, l, o, s, a = !1) => {
          const u = e && e.children, p = e ? e.shapeFlag : 0, d = t.children, {patchFlag: h, shapeFlag: f} = t;
          if (h > 0) {
          ...
          t = t || Z;
          const c = (e = e || Z).length, u = t.length, p = Math.min(c, u);
          let d;
          for (d = 0; d < p; d++) {
          ...
          if (c > p) {
            ...
            for (v = _.length - 1, c = w - 1; c >= 0; c--) {
              const e = g + c, p = t[e], d = e + 1 < u ? t[e + 1].el : r;
          ...
          if (2 !== i && 1 & u && a) if (0 === i) a.beforeEnter(o), n(o, t, r), br((() => a.enter(o)), l); else {
            const {leave: e, delayLeave: i, afterLeave: l} = a, s = () => n(o, t, r), c = () => {
              e(o, (() => {
                s(), l && l()
              }))
            };
          ...
          const {type: l, props: o, ref: s, children: a, dynamicChildren: c, shapeFlag: u, patchFlag: p, dirs: d} = e;
          if (null != s && wr(s, null, n, e, !0), 256 & u) return void t.ctx.deactivate(e);
          const h = 1 & u && d, f = !Vn(e);
          let g;
          ...
          const {type: t, el: n, anchor: i, transition: l} = e;
          ...
          if (1 & e.shapeFlag && l && !l.persisted) {
            const {leave: t, delayLeave: r} = l, i = () => t(n, o);
            r ? r(e.el, o, i) : i()
          } else o()
        }, N = (e, t) => {
          let n;
          ...
          const {bum: r, scope: i, update: l, subTree: o, um: s} = e;
        ...
        }, H = {p: f, um: U, m: P, r: M, mt: R, mc: _, pc: O, pbc: S, n: V, o: e};
    let W, K;
    t && ([W, K] = t(H));
    return {render: B, hydrate: W, createApp: yr(B, W)}
  }(e)
}
...
const Cr = Symbol(void 0), Sr = Symbol(void 0), $r = Symbol(void 0), Ir = Symbol(void 0), Er = [];
let Rr = null;
...
const Mr = "__vInternal", Nr = ({key: e}) => null != e ? e : null,
    Fr = ({ref: e, ref_key: t, ref_for: n}) => null != e ? ae(e) || Gt(e) || se(e) ? {
      i: En,
      r: e,
      k: t,
      f: !!n
...
function Dr(e, t = null, n = null, r = 0, i = null, l = (e === Cr ? 0 : 1), o = !1, s = !1) {
  const a = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
...
const Vr = function (e, t = null, n = null, r = 0, i = null, l = !1) {
  e && e !== Qn || (e = $r);
  if (Pr(e)) {
    const r = Br(e, t, !0);
...
function Br(e, t, n = !1) {
  const {props: r, ref: i, patchFlag: l, children: o} = e, s = t ? function (...e) {
    const t = {};
    for (let n = 0; n < e.length; n++) {
      const r = e[n];
...
function Gr(e, t) {
  ...
  } else se(t) ? (t = {default: t, _ctx: En}, n = 32) : (t = String(t), 64 & r ? (n = 16, t = [Hr(t)]) : n = 8);
...
const ai = Symbol(""), ci = () => Tn(ai), ui = "3.2.45", pi = "undefined" != typeof document ? document : null,
    di = pi && pi.createElement("template"), hi = {
      insert: (e, t, n) => {
      ...
      createElement: (e, t, n, r) => {
        const i = t ? pi.createElementNS("http://www.w3.org/2000/svg", e) : pi.createElement(e, n ? {is: n} : void 0);
...
const Ei = {
  ...
  deep: !0, created(e, t, n) {
    e._assign = Si(n), wi(e, "change", (() => {
      const t = e._modelValue, n = ji(e), r = e.checked, i = e._assign;
      if (re(t)) {
        const e = B(t, n), l = -1 !== e;
  ...
  }, mounted: Li, beforeUpdate(e, t, n) {
    e._assign = Si(n), Li(e, t, n)
  }
};

function Li(e, {value: t, oldValue: n}, r) {
...
let Di;
const Vi = (...e) => {
  const t = (Di || (Di = kr(Fi))).createApp(...e), {mount: n} = t;
  return t.mount = e => {
    const r = function (e) {
      if (ae(e)) {
...
var Bi;
const Hi = "undefined" != typeof window, Wi = () => {
};
...
function Qi(e, t = 200, n = {}) {
  return Zi(function (e, t = {}) {
    let n, r;
    return i => {
      const l = qi(e), o = qi(t.maxWait);
...
var Yi = Object.getOwnPropertySymbols, Xi = Object.prototype.hasOwnProperty, el = Object.prototype.propertyIsEnumerable;

function tl(e, t, n = {}) {
  const r = n, {eventFilter: i = Gi} = r, l = ((e, t) => {
    var n = {};
...
var nl = Object.defineProperty, rl = Object.defineProperties, il = Object.getOwnPropertyDescriptors,
    ll = Object.getOwnPropertySymbols, ol = Object.prototype.hasOwnProperty, sl = Object.prototype.propertyIsEnumerable,
    al = (e, t, n) => t in e ? nl(e, t, {enumerable: !0, configurable: !0, writable: !0, value: n}) : e[t] = n;

function cl(e, t, n = {}) {
  const r = n, {eventFilter: i} = r, l = ((e, t) => {
    var n = {};
    for (var r in e) ol.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
    if (null != e && ll) for (var r of ll(e)) t.indexOf(r) < 0 && sl.call(e, r) && (n[r] = e[r]);
    return n
  })(r, ["eventFilter"]), {eventFilter: o, pause: s, resume: a, isActive: c} = function (e = Gi) {
    const t = Kt(!0);
    return {
      isActive: t, pause: function () {
        t.value = !1
      }, resume: function () {
        t.value = !0
      }, eventFilter: (...n) => {
    ...
    return e
  })({}, l), rl(p, il({eventFilter: o}))));
  var p;
  return {stop: u, pause: s, resume: a, isActive: c}
}

const ul = Hi ? window : void 0, pl = Hi ? window.document : void 0;
...
hl[fl] = hl[fl] || {};
const gl = hl[fl];
var ml = Object.defineProperty, vl = Object.getOwnPropertySymbols, yl = Object.prototype.hasOwnProperty,
    wl = Object.prototype.propertyIsEnumerable,
    bl = (e, t, n) => t in e ? ml(e, t, {enumerable: !0, configurable: !0, writable: !0, value: n}) : e[t] = n,
    kl = (e, t) => {
...
function _l(e, t, n, r = {}) {
  ...
  }(g), v = null != (i = r.serializer) ? i : xl[m], {pause: y, resume: w} = cl(f, (() => function (t) {
    try {
      null == t ? n.removeItem(e) : n.setItem(e, v.write(t))
    } catch (e) {
      h(e)
    }
  }(f.value)), {flush: l, deep: o, eventFilter: d});
...
var Cl, Sl, $l = Object.defineProperty, Il = Object.getOwnPropertySymbols, El = Object.prototype.hasOwnProperty,
    Rl = Object.prototype.propertyIsEnumerable,
    Ll = (e, t, n) => t in e ? $l(e, t, {enumerable: !0, configurable: !0, writable: !0, value: n}) : e[t] = n;

function Al(e = {}) {
  const {controls: t = !1, interval: n = "requestAnimationFrame"} = e, r = Kt(new Date), i = () => r.value = new Date,
      l = "requestAnimationFrame" === n ? function (e, t = {}) {
        const {immediate: n = !0, window: r = ul} = t, i = Kt(!1);
        let l = null;
        ...
        return n && s(), Ki(a), {isActive: i, pause: a, resume: s}
      }(i, {immediate: !0}) : function (e, t = 1e3, n = {}) {
        ...
        return Ki(a), {isActive: o, pause: a, resume: c}
      }(i, n, {immediate: !0});
  return t ? ((e, t) => {
...
let zl = 0;
var Ol = Object.defineProperty, jl = Object.getOwnPropertySymbols, Tl = Object.prototype.hasOwnProperty,
    Pl = Object.prototype.propertyIsEnumerable,
    Ul = (e, t, n) => t in e ? Ol(e, t, {enumerable: !0, configurable: !0, writable: !0, value: n}) : e[t] = n;
((e, t) => {
...
const Ml = e => {
      const t = _l("WALINE_EMOJI", {}), n = Boolean(/@[0-9]+\.[0-9]+\.[0-9]+/.test(e));
      if (n) {
        const n = t.value[e];
...
function vo(e, t, n, r) {
  const i = t.href, l = t.title ? Yl(t.title) : null, o = e[1].replace(/\\([\[\]])/g, "$1");
  if ("!" !== e[0].charAt(0)) {
    r.state.inLink = !0;
    const e = {type: "link", raw: n, href: i, title: l, text: o, tokens: r.inlineTokens(o)};
    return r.state.inLink = !1, e
  }
  return {type: "image", raw: n, href: i, title: l, text: Yl(o)}
}
...
class yo {
  ...
  code(e) {
    ...
    if (t) {
      ...
      return {type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? e : fo(e, "\n")}
    }
  }
  ...
  list(e) {
    ...
    if (t) {
      let n, r, i, l, o, s, a, c, u, p, d, h, f = t[1].trim();
      const g = f.length > 1,
      ...
      for (; e && (h = !1, t = v.exec(e)) && !this.rules.block.hr.test(e);) {
        if (n = t[0], e = e.substring(n.length), c = t[2].split("\n", 1)[0], u = e.split("\n", 1)[0], this.options.pedantic ? (l = 2, d = c.trimLeft()) : (l = t[2].search(/[^ ]/), l = l > 4 ? 1 : l, d = c.slice(l), l += t[1].length), s = !1, !c && /^ *$/.test(u) && (n += u + "\n", e = e.substring(u.length + 1), h = !0), !h) {
          const t = new RegExp(`^ {0,${Math.min(3,l-1)}}(?:[*+-]|\\d{1,9}[.)])((?: [^\\n]*)?(?:\\n|$))`),
              ...
              i = new RegExp(`^ {0,${Math.min(3,l-1)}}(?:\`\`\`|~~~)`), o = new RegExp(`^ {0,${Math.min(3,l-1)}}#`);
      ...
      for (o = 0; o < y; o++) {
        ...
        const e = m.items[o].tokens.filter((e => "space" === e.type)), t = e.every((e => {
          const t = e.raw.split("");
          let n = 0;
          for (const e of t) if ("\n" === e && (n += 1), n > 1) return !0;
          return !1
  ...
  table(e) {
    ...
    if (t) {
      const e = {
        type: "table",
        header: ho(t[1]).map((e => ({text: e}))),
        align: t[2].replace(/^ *|\| *$/g, "").split(/ *\| */),
        rows: t[3] && t[3].trim() ? t[3].replace(/\n[ \t]*$/, "").split("\n") : []
      };
      if (e.header.length === e.align.length) {
        e.raw = t[0];
        let n, r, i, l, o = e.align.length;
        ...
        for (o = e.rows.length, n = 0; n < o; n++) e.rows[n] = ho(e.rows[n], e.header.length).map((e => ({text: e})));
  ...
  escape(e) {
    ...
    if (t) return {type: "escape", raw: t[0], text: Yl(t[1])}
  }
  ...
  codespan(e) {
    ...
    if (t) {
      ...
      return n && r && (e = e.substring(1, e.length - 1)), e = Yl(e, !0), {type: "codespan", raw: t[0], text: e}
    }
  }
...
class _o {
  constructor(e) {
    ...
    const t = {block: wo.normal, inline: bo.normal};
...
class Io {
  ...
  parse(e, t = !0) {
    let n, r, i, l, o, s, a, c, u, p, d, h, f, g, m, v, y, w, b, k = "";
    const x = e.length;
    for (n = 0; n < x; n++) if (p = e[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type] && (b = this.options.extensions.renderers[p.type].call({parser: this}, p), !1 !== b || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(p.type))) k += b || ""; else switch (p.type) {
      case"space":
        continue;
      case"hr":
        k += this.renderer.hr();
  ...
  parseInline(e, t) {
    ...
    let n, r, i, l = "";
    const o = e.length;
    for (n = 0; n < o; n++) if (r = e[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[r.type] && (i = this.options.extensions.renderers[r.type].call({parser: this}, r), !1 !== i || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(r.type))) l += i || ""; else switch (r.type) {
      case"escape":
      case"text":
        l += t.text(r.text);
        break;
...
}, Eo.getDefaults = Hl, Eo.defaults = Wl, Eo.use = function (...e) {
  const t = po({}, ...e), n = Eo.defaults.extensions || {renderers: {}, childTokens: {}};
  let r;
  e.forEach((e => {
...
const Ro = /\$.*?\$/, Lo = /^\$(.*?)\$/, Ao = /^(?:\s{0,3})\$\$((?:[^\n]|\n[^\n])+?)\n{0,1}\$\$/,
    zo = (e = "", t = {}) => e.replace(/:(.+?):/g, ((e, n) => t[n] ? `<img class="wl-emoji" src="${t[n]}" alt="${n}">` : e)),
    Oo = (e, {emojiMap: t, highlighter: n, texRenderer: r}) => {
      if (Eo.setOptions({highlight: n || void 0, breaks: !0, smartLists: !0, smartypants: !0}), r) {
        const e = (e => [{
          ...
          name: "inlineMath", level: "inline", start(e) {
            const t = e.search(Ro);
    ...
    }, jo = e => e.dataset.path || e.getAttribute("id"), To = ({
                                                                 serverURL: e,
                                                                 path: t = window.location.pathname,
                                                                 selector: n = ".waline-comment-count",
                                                                 lang: r = "zh-CN"
                                                               }) => {
      const i = new AbortController, l = document.querySelectorAll(n);
      return l.length && (({
                             serverURL: e,
                             lang: t,
                             paths: n,
                             signal: r
                           }) => fetch(`${e}/comment?type=count&url=${encodeURIComponent(n.join(","))}&lang=${t}`, {signal: r}).then((e => e.json())).then((e => Array.isArray(e) ? e : [e])))({
        serverURL: I(e),
...
var Mo = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
    No = {}, Fo = {}, Do = {}, Vo = Mo && Mo.__awaiter || function (e, t, n, r) {
      ...
      return l = {next: s(0), throw: s(1), return: s(2)}, "function" == typeof Symbol && (l[Symbol.iterator] = function () {
        return this
      }), l;
...
Object.defineProperty(Do, "__esModule", {value: !0}), Do.ReCaptchaInstance = void 0;
var Ho = function () {
  function e(e, t, n) {
  ...
  return e.prototype.execute = function (e) {
    return Vo(this, void 0, void 0, (function () {
      return Bo(this, (function (t) {
        return [2, this.recaptcha.enterprise ? this.recaptcha.enterprise.execute(this.recaptchaID, {action: e}) : this.recaptcha.execute(this.recaptchaID, {action: e})]
      }))
    }))
...
Do.ReCaptchaInstance = Ho, Object.defineProperty(Fo, "__esModule", {value: !0}), Fo.getInstance = Fo.load = void 0;
var Wo, qo = Do;
!function (e) {
...
var Zo = function () {
  ...
  return e.load = function (t, n) {
    ...
    var i = {sitekey: t, badge: n.badge, size: n.size, tabindex: n.tabindex};
...
var Xo = Dn({
  setup() {
    const e = Kt([]), t = Qo(), n = Tn("config"), r = oi((() => n.value.locale)), i = oi((() => {
      const {reaction: i, path: l} = n.value;
      return i.map(((n, i) => ({
        icon: n,
        vote: e.value[i] || 0,
        desc: r.value[`reaction${i}`],
        active: Boolean(t.value.find((({id: e, i: t}) => e === l && t === i)))
      })))
    }));
    let l;
    return Hn((() => {
      Mn((() => [n.value.serverURL, n.value.path]), (() => {
        (() => {
          const {serverURL: t, lang: r, path: i, reaction: o} = n.value;
          if (o.length) {
      ...
      reaction: i, locale: r, vote: async r => {
        const {serverURL: i, lang: l, path: o} = n.value, s = t.value.find((({id: e}) => e === o));
        s && s.i === r || (await x({
          serverURL: i,
          lang: l,
          path: o,
...
const ts = {key: 0, class: "wl-reaction"}, ns = ["textContent"], rs = ["onClick"], is = {class: "wl-reaction-img"},
    ls = ["src", "alt"], os = {class: "wl-reaction-votes"}, ss = {class: "wl-reaction-text"};
var as, cs, us = es(Xo, [["render", function (e, t, n, r, i, l) {
  return e.reaction.length ? (Lr(), jr("div", ts, [Dr("h4", {textContent: H(e.locale.reactionTitle)}, null, 8, ns), Dr("ul", null, [(Lr(!0), jr(Cr, null, Yn(e.reaction, ((t, n) => (Lr(), jr("li", {
    key: n,
    class: N({active: t.active}),
    onClick: t => e.vote(n)
  }, [Dr("div", is, [Dr("img", {
    src: t.icon,
    alt: t.desc
  }, null, 8, ls), Dr("div", os, H(t.vote), 1)]), Dr("div", ss, H(t.desc), 1)], 10, rs)))), 128))])])) : Wr("v-if", !0)
}], ["__file", "ArticleReaction.vue"]]), ps = "function" == typeof Map ? new Map : (as = [], cs = [], {
  has: function (e) {
  ...
  return e && Array.prototype.forEach.call(e.length ? e : [e], (function (e) {
    return function (e) {
      if (e && e.nodeName && "TEXTAREA" === e.nodeName && !ps.has(e)) {
        var t, n = null, r = null, i = null, l = function () {
          e.clientWidth !== r && c()
        }, o = function (t) {
...
var ys = Dn({
  ...
  setup(e) {
    let t = null;
    const n = Kt(null), r = Kt({}), i = Kt([]), l = () => {
      const t = Math.floor((n.value.getBoundingClientRect().width + e.gap) / (e.columnWidth + e.gap));
      return t > 0 ? t : 1
    }, o = async t => {
      if (t >= e.items.length) return;
      await vn();
      const r = Array.from(n.value?.children || []).reduce(((e, t) => t.getBoundingClientRect().height < e.getBoundingClientRect().height ? t : e));
      ...
      await o(0), window.scrollTo({top: n})
    };
    return Hn((() => {
      ...
      columns: i, state: r, wall: n, imageLoad: e => {
        r.value[e.target.src] = !0
      }
    }
  }
});
const ws = ["data-index"], bs = ["src", "title", "onClick"];
var ks = Dn({
  name: "CommentBox",
  components: {
    CloseIcon: ({size: e}) => si("svg", {
      class: "wl-close-icon",
    ...
    EmojiIcon: () => si("svg", {viewBox: "0 0 1024 1024", width: "24", height: "24"}, si("path", {
    ...
    ImageWall: es(ys, [["render", function (e, t, n, r, i, l) {
      ...
      return Lr(), jr("div", {
        ref: "wall",
        class: "wl-gallery",
        style: j({gap: `${e.gap}px`})
      }, [(Lr(!0), jr(Cr, null, Yn(e.columns, ((n, r) => (Lr(), jr("div", {
        key: r,
        class: "wl-gallery-column",
        "data-index": r,
        style: j({gap: `${e.gap}px`})
      }, [(Lr(!0), jr(Cr, null, Yn(n, (n => (Lr(), jr(Cr, {key: n}, [e.state[e.items[n].src] ? Wr("v-if", !0) : (Lr(), Tr(o, {
        key: 0,
        size: 36,
        ...
        loading: "lazy",
        onLoad: t[0] || (t[0] = (...t) => e.imageLoad && e.imageLoad(...t)),
  ...
  setup(e, {emit: t}) {
    const n = Tn("config"), r = _l("WALINE_COMMENT_BOX_EDITOR", ""),
        i = _l("WALINE_USER_META", {nick: "", mail: "", link: ""}), l = Yo(), o = Kt({}), s = Kt(null), a = Kt(null),
        c = Kt(null), u = Kt(null), p = Kt(null), d = Kt(null), h = Kt(null), f = Kt({tabs: [], map: {}}), g = Kt(0),
        m = Kt(!1), v = Kt(!1), y = Kt(!1), w = Kt(""), b = Kt(0), k = Tt({loading: !0, list: []}), x = Kt(0),
        C = Kt(!1), $ = Kt(""), I = Kt(!1), E = oi((() => n.value.locale)), R = oi((() => Boolean(l.value?.token))),
        L = oi((() => !1 !== n.value.imageUploader)), A = e => {
          const t = s.value, n = t.selectionStart, i = t.selectionEnd || 0, l = t.scrollTop;
          ...
          const {serverURL: a, lang: c, login: u, wordLimit: p, requiredMeta: d} = n.value;
          let h = "";
          n.value.recaptchaV3Key && (h = await (e => {
            const t = Go[e] ?? (Go[e] = No.load(e, {useRecaptchaNet: !0, autoHideBadge: !0}));
          ...
          if (l.value?.token) g.nick = l.value.display_name, g.mail = l.value.email, g.link = l.value.url; else {
            if ("force" === u) return;
            if (d.indexOf("nick") > -1 && !g.nick) return o.value.nick?.focus(), alert(E.value.nickError);
            if (d.indexOf("mail") > -1 && !g.mail || g.mail && !/^\w(?:[\w._-]*\w)?@(?:\w(?:[\w-]*\w)?\.)*\w+$/.exec(g.mail)) return o.value.mail?.focus(), alert(E.value.mailError);
            if (!g.comment) return void s.value?.focus();
          ...
          const m = {serverURL: a, lang: c, token: l.value?.token, comment: g};
          (e.edit ? _({objectId: e.edit.objectId, ...m}) : (({serverURL: e, lang: t, token: n, comment: r}) => {
            ...
            t("submit", n.data), r.value = "", w.value = "", e.replyId && t("cancel-reply"), e.edit?.objectId && t("cancel-edit")
          })).catch((e => {
          ...
          const {scrollTop: t, clientHeight: r, scrollHeight: i} = e.target, l = (r + t) / i, o = n.value.search,
              s = h.value?.value || "";
    ...
    const U = ({data: e}) => {
      e && "profile" === e.type && (l.value = {...l.value, ...e.data}, [localStorage, sessionStorage].filter((e => e.getItem("WALINE_USER"))).forEach((e => e.setItem("WALINE_USER", JSON.stringify(l)))))
    };
    return Hn((() => {
      document.body.addEventListener("click", j), window.addEventListener("message", U), e.edit?.objectId && (r.value = e.edit.orig), Mn(v, (async e => {
        if (!e) return;
        const t = n.value.search;
        h.value && (h.value.value = ""), k.loading = !0, k.list = t.default ? await t.default() : await t.search(""), k.loading = !1
      })), Mn((() => r.value), (e => {
        const {highlighter: t, texRenderer: r} = n.value;
      ...
      }), {immediate: !0}), Mn((() => n.value.emoji), (e => {
        return (t = Array.isArray(e) ? e : [], Promise.all(t.map((e => "string" == typeof e ? Ml(S(e)) : Promise.resolve(e)))).then((e => {
          const t = {tabs: [], map: {}};
          return e.forEach((e => {
            const {name: n, folder: r, icon: i, prefix: l, type: o, items: s} = e;
            t.tabs.push({
              name: n, icon: Nl(i, r, l, o), items: s.map((e => {
                const n = `${l || ""}${e}`;
      ...
      onLogin: e => {
        ...
        (({lang: e, serverURL: t}) => {
          ...
          return i?.postMessage({type: "TOKEN", data: null}, "*"), new Promise((e => {
            const t = ({data: n}) => {
              n && "object" == typeof n && "userInfo" === n.type && n.data.token && (i?.close(), window.removeEventListener("message", t), e(n.data))
            };
      ...
      onProfile: e => {
        e.preventDefault();
        const {lang: t, serverURL: r} = n.value, i = (window.innerWidth - 800) / 2, o = (window.innerHeight - 800) / 2,
            s = new URLSearchParams({lng: t, token: l.value.token});
        window.open(`${r}/ui/profile?${s.toString()}`, "_blank", `width=800,height=800,left=${i},top=${o},scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no`)?.postMessage({
          type: "TOKEN",
          data: l.value.token
        }, "*")
      },
...
const xs = {class: "wl-comment"}, _s = {key: 0, class: "wl-login-info"}, Cs = {class: "wl-avatar"}, Ss = ["title"],
    $s = ["title"], Is = ["src"], Es = ["title", "textContent"], Rs = {class: "wl-panel"}, Ls = ["for", "textContent"],
    As = ["id", "onUpdate:modelValue", "name", "type"], zs = ["placeholder"], Os = {class: "wl-preview"},
    js = Dr("hr", null, null, -1), Ts = ["innerHTML"], Ps = {class: "wl-footer"}, Us = {class: "wl-actions"}, Ms = {
      ...
      target: "_blank",
      rel: "noreferrer"
    }, Ns = ["title"], Fs = ["title"], Ds = ["title"], Vs = ["title"], Bs = {class: "wl-info"},
    Hs = {class: "wl-text-number"}, Ws = {key: 0}, qs = ["textContent"], Zs = ["textContent"], Gs = ["disabled"],
    Ks = ["placeholder"], Qs = {key: 0, class: "wl-loading"}, Js = {key: 0, class: "wl-tab-wrapper"},
    Ys = ["title", "onClick"], Xs = ["src", "alt"], ea = {key: 0, class: "wl-tabs"}, ta = ["onClick"],
    na = ["src", "alt", "title"], ra = ["title"];
var ia = es(ks, [["render", function (e, t, n, r, i, l) {
  const o = Kn("CloseIcon"), s = Kn("MarkdownIcon"), a = Kn("EmojiIcon"), c = Kn("GifIcon"), u = Kn("ImageIcon"),
      p = Kn("PreviewIcon"), d = Kn("LoadingIcon"), h = Kn("ImageWall");
  return Lr(), jr("div", xs, ["disable" !== e.config.login && e.isLogin && !e.edit?.objectId ? (Lr(), jr("div", _s, [Dr("div", Cs, [Dr("button", {
    class: "wl-logout-btn",
    title: e.locale.logout,
    onClick: t[0] || (t[0] = (...t) => e.onLogout && e.onLogout(...t))
  }, [Vr(o, {size: 14})], 8, Ss), Dr("a", {
    href: "#",
    class: "wl-login-nick",
    "aria-label": "Profile",
    title: e.locale.profile,
    onClick: t[1] || (t[1] = (...t) => e.onProfile && e.onProfile(...t))
  }, [Dr("img", {src: e.userInfo.avatar, alt: "avatar"}, null, 8, Is)], 8, $s)]), Dr("a", {
    href: "#",
    class: "wl-login-nick",
    "aria-label": "Profile",
    title: e.locale.profile,
    onClick: t[2] || (t[2] = (...t) => e.onProfile && e.onProfile(...t)),
    ...
    onKeydown: t[4] || (t[4] = (...t) => e.onKeyDown && e.onKeyDown(...t)),
    onDrop: t[5] || (t[5] = (...t) => e.onDrop && e.onDrop(...t)),
    onPaste: t[6] || (t[6] = (...t) => e.onPaste && e.onPaste(...t))
    ...
    ref: "emojiButtonRef",
    class: N(["wl-action", {active: e.showEmoji}]),
    ...
    key: 0,
    ref: "gifButtonRef",
    class: N(["wl-action", {active: e.showGif}]),
    title: e.locale.gif,
    ...
    onChange: t[9] || (t[9] = (...t) => e.onChange && e.onChange(...t))
    ...
    class: N(["wl-action", {active: e.showPreview}]),
    ...
    class: N({illegal: !e.isWordNumberLegal}),
    ...
    key: 0,
    class: "wl-btn",
    onClick: t[11] || (t[11] = (...t) => e.onLogin && e.onLogin(...t)),
    ...
    onClick: t[12] || (t[12] = (...t) => e.submitComment && e.submitComment(...t))
  }, [e.isSubmitting ? (Lr(), Tr(d, {
    key: 0,
    size: 16
  })) : (Lr(), jr(Cr, {key: 1}, [Hr(H(e.locale.submit), 1)], 64))], 8, Gs)) : Wr("v-if", !0)]), Dr("div", {
    ref: "gifPopupRef",
    class: N(["wl-gif-popup", {display: e.showGif}])
  }, [Dr("input", {
    ref: "gifSearchInputRef",
    type: "text",
    placeholder: e.locale.gifSearchPlaceholder,
    onInput: t[13] || (t[13] = (...t) => e.onGifSearch && e.onGifSearch(...t))
  }, null, 40, Ks), Vr(h, {
  ...
  }, null, 8, ["items", "onScroll"]), e.gifData.loading ? (Lr(), jr("div", Qs, [Vr(d, {size: 30})])) : Wr("v-if", !0)], 2), Dr("div", {
    ref: "emojiPopupRef",
    class: N(["wl-emoji-popup", {display: e.showEmoji}])
  }, [(Lr(!0), jr(Cr, null, Yn(e.emoji.tabs, ((t, n) => (Lr(), jr(Cr, {key: t.name}, [n === e.emojiTabIndex ? (Lr(), jr("div", Js, [(Lr(!0), jr(Cr, null, Yn(t.items, (t => (Lr(), jr("button", {
    key: t,
    title: t,
    ...
    key: t.name,
    class: N(["wl-tab", {active: e.emojiTabIndex === n}]),
    ...
    loading: "lazy",
    referrerPolicy: "no-referrer"
  }, null, 8, na)], 10, ta)))), 128))])) : Wr("v-if", !0)], 2)])]), e.replyId || e.edit?.objectId ? (Lr(), jr("button", {
    key: 1,
    class: "wl-close",
    title: e.locale.cancelReply,
    onClick: t[15] || (t[15] = t => e.$emit(e.replyId ? "cancel-reply" : "cancel-edit"))
  }, [Vr(o, {size: 24})], 8, ra)) : Wr("v-if", !0)])
...
var oa = Dn({
  components: {
    ...
    LikeIcon: ({active: e = !1}) => si("svg", {viewBox: "0 0 1024 1024", width: "24", height: "24"}, [si("path", {
  ...
  setup(e) {
    const t = Tn("config"), n = Uo(), r = Yo(), i = oi((() => t.value.locale)), l = oi((() => {
          const {link: t} = e.comment;
          return t ? $(t) ? t : `https://${t}` : ""
        })), o = oi((() => n.value.includes(e.comment.objectId))), s = ((e, t) => {
          const n = Al();
          return oi((() => z(e, n.value, t)))
        })(e.comment.insertedAt, i.value), a = oi((() => "administrator" === r.value.type)),
        c = oi((() => e.comment.user_id && r.value.objectId === e.comment.user_id)),
        u = oi((() => e.comment.objectId === e.reply?.objectId)),
        p = oi((() => e.comment.objectId === e.edit?.objectId));
    return {
      config: t,
      locale: i,
      isReplyingCurrent: u,
...
const sa = ["id"], aa = {class: "wl-user", "aria-hidden": "true"}, ca = ["src"], ua = {class: "wl-card"},
    pa = {class: "wl-head"}, da = ["href"], ha = {key: 1, class: "wl-nick"}, fa = ["textContent"], ga = ["textContent"],
    ma = ["textContent"], va = ["textContent"], ya = ["textContent"], wa = {class: "wl-comment-actions"},
    ba = ["title"], ka = ["textContent"], xa = ["title"], _a = {class: "wl-meta", "aria-hidden": "true"},
    Ca = ["data-value", "textContent"], Sa = ["data-value", "textContent"], $a = ["data-value", "textContent"],
    Ia = ["innerHTML"], Ea = {key: 1, class: "wl-admin-actions"}, Ra = {class: "wl-comment-status"},
    La = ["disabled", "onClick", "textContent"], Aa = {key: 3, class: "wl-quote"};
var za = es(oa, [["render", function (e, t, n, r, i, l) {
  const o = Kn("VerifiedIcon"), s = Kn("EditIcon"), a = Kn("DeleteIcon"), c = Kn("LikeIcon"), u = Kn("ReplyIcon"),
      p = Kn("CommentBox"), d = Kn("CommentCard", !0);
  return Lr(), jr("div", {
  ...
  }, null, 8, ca)) : Wr("v-if", !0), e.comment.type ? (Lr(), Tr(o, {key: 1})) : Wr("v-if", !0)]), Dr("div", ua, [Dr("div", pa, [e.link ? (Lr(), jr("a", {
    key: 0,
    class: "wl-nick",
    href: e.link,
    target: "_blank",
  ...
  }, [Vr(c, {active: e.like}, null, 8, ["active"]), "like" in e.comment ? (Lr(), jr("span", {
    key: 0,
    textContent: H(e.comment.like)
  }, null, 8, ka)) : Wr("v-if", !0)], 8, ba), Dr("button", {
    class: N(["wl-reply", {active: e.isReplyingCurrent}]),
    ...
    key: 2,
    class: N({"wl-reply-wrapper": e.isReplyingCurrent, "wl-edit-wrapper": e.isEditingCurrent})
  }, [Vr(p, {
    edit: e.edit,
...
const Oa = {latest: "insertedAt_desc", oldest: "insertedAt_asc", hottest: "like_desc"}, ja = Object.keys(Oa);
var Ta = Dn({
  name: "WalineRoot",
  components: {Reaction: us, CommentBox: ia, CommentCard: za, LoadingIcon: vs},
  ...
  setup(e) {
    const o = e, s = oi((() => (({
          ...
          serverURL: I(e),
          path: C(o),
          locale: {...y[s] || y["zh-CN"], ..."object" == typeof a ? a : {}},
          wordLimit: E(g),
          meta: t(p),
          requiredMeta: t(d),
          imageUploader: R(m, n),
          ...
          commentSorting: $, ...L
        }))(o))), a = Yo(), u = Uo(), p = Kt("loading"), d = Kt(0), h = Kt(1), f = Kt(0), g = Kt(s.value.commentSorting),
        m = Kt([]), v = Kt(null), w = Kt(null), k = oi((() => {
          return "string" == typeof (e = s.value.dark) ? "auto" === e ? `@media(prefers-color-scheme:dark){body${L}}` : `${e}${L}` : !0 === e ? `:root${L}` : "";
          var e
        }));
    let x;
    !function (e, t = {}) {
      const n = Kt(!1), {document: r = pl, immediate: i = !0, manual: l = !1, id: o = "vueuse_styletag_" + ++zl} = t,
          s = Kt(e);
      let a = () => {
      };
      const c = () => {
    ...
    const S = e => {
      const {serverURL: t, path: n, pageSize: r} = s.value, i = new AbortController;
      p.value = "loading", x?.(), (({
                                      serverURL: e,
                                      lang: t,
                                      path: n,
    ...
    return function (e, t) {
      ...
      Mn((() => [o.serverURL, o.path]), (() => $()), {immediate: !0})
    })), qn((() => x?.())), {
      config: s,
      darkmodeStyle: k,
      ...
      onSubmit: e => {
        if (w.value) w.value.comment = e.comment, w.value.orig = e.orig; else if (e.rid) {
          const t = m.value.find((({objectId: t}) => t === e.rid));
          if (!t) return;
          Array.isArray(t.children) || (t.children = []), t.children.push(e)
        } else m.value.unshift(e)
      },
      onStatusChange: async ({comment: e, status: t}) => {
        if (e.status === t) return;
        const {serverURL: n, lang: r} = s.value;
        await _({serverURL: n, lang: r, token: a.value?.token, objectId: e.objectId, status: t}), e.status = t
      },
      onDelete: async ({objectId: e}) => {
        if (!confirm("Are you sure you want to delete this comment?")) return;
        const {serverURL: t, lang: n} = s.value;
        await (({
                  serverURL: e,
                  lang: t,
                  token: n,
      ...
      onLike: async e => {
        const {serverURL: t, lang: n} = s.value, {objectId: r} = e, i = u.value.includes(r);
        await _({
          serverURL: t,
          lang: n,
          objectId: r,
...
const Pa = {"data-waline": ""}, Ua = {class: "wl-meta-head"}, Ma = {class: "wl-count"}, Na = ["textContent"],
    Fa = {class: "wl-sort"}, Da = ["onClick"], Va = {class: "wl-cards"}, Ba = {key: 1, class: "wl-operation"},
    Ha = ["textContent"], Wa = {key: 0, class: "wl-loading"}, qa = ["textContent"], Za = {class: "wl-operation"},
    Ga = ["textContent"], Ka = {key: 3, class: "wl-power"},
    Qa = Dr("a", {href: "https://github.com/walinejs/waline", target: "_blank", rel: "noreferrer"}, " Waline ", -1);
var Ja = es(Ta, [["render", function (e, t, n, r, i, l) {
  const o = Kn("Reaction"), s = Kn("CommentBox"), a = Kn("CommentCard"), c = Kn("LoadingIcon");
  return Lr(), jr("div", Pa, [Vr(o), e.reply ? Wr("v-if", !0) : (Lr(), Tr(s, {
    ...
    type: "button",
    class: "wl-btn",
    onClick: t[0] || (t[0] = (...t) => e.refresh && e.refresh(...t)),
    textContent: H(e.i18n.refresh)
  }, null, 8, Ha)])) : (Lr(), jr(Cr, {key: 2}, ["loading" === e.status ? (Lr(), jr("div", Wa, [Vr(c, {size: 30})])) : e.data.length ? e.page < e.totalPages ? (Lr(), jr(Cr, {key: 2}, [Wr(" Load more button "), Dr("div", Za, [Dr("button", {
    type: "button",
    class: "wl-btn",
    onClick: t[1] || (t[1] = (...t) => e.loadMore && e.loadMore(...t)),
...
const Ya = (e, t) => {
  ...
  const l = new AbortController, o = Array.from(document.querySelectorAll(n)), s = e => {
    const n = jo(e);
    return null !== n && t !== n
  }, a = n => (({serverURL: e, lang: t, paths: n, signal: r}) => k({
    serverURL: e,
    lang: t,
    paths: n,
    type: ["time"],
  ...
  if (r) {
    const n = o.filter((e => !s(e))), r = o.filter(s);
    (c = {serverURL: I(e), path: t, lang: i}, x({
      ...c,
      type: "time",
      action: "inc"
...
}, ec = ({el: e = "#waline", path: t = window.location.pathname, comment: n = !1, pageview: r = !1, ...i}) => {
  const l = e ? Dl(e) : null;
  if (e && !l) throw new Error("Option 'el' do not match any domElement!");
  if (!i.serverURL) throw new Error("Option 'serverURL' is missing!");
  const o = Tt({...i}), s = Tt({comment: n, pageview: r, path: t}),
      a = l ? Vi((() => si(Ja, {path: s.path, ...o}))) : null;
  a && a.mount(l);
  const c = Pn((() => {
    s.comment && To({serverURL: o.serverURL, path: s.path, selector: "string" == typeof s.comment ? s.comment : void 0})
  })), u = Pn((() => {
    s.pageview && Xa({
  ...
  return {
    el: l, update: ({comment: e, pageview: t, path: n = window.location.pathname, ...r} = {}) => {
...
}, tc = "2.14.1", nc = ({el: e, serverURL: t, count: n, lang: r = "zh-CN"}) => {
  const i = Yo(), l = Dl(e), o = new AbortController;
  return (({serverURL: e, lang: t, count: n, signal: r, token: i}) => {
    const l = {};
