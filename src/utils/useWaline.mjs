const e = ['nick', 'mail', 'link'],
  ...
  o = new RegExp(
    ...
    }|${/</.source})|((?:${/(?:^|\s)\/\/(.+?)$/gm.source})|(?:${/\/\*([\S\s]*?)\*\//gm.source}))`,
    'gmi'
  ),
  s = [
    '23AC69',
...
const y = {
  ...
  k = ({ serverURL: e, lang: t, paths: n, type: r, signal: i }) =>
    fetch(
      `${e}/article?path=${encodeURIComponent(n.join(','))}&type=${encodeURIComponent(
        r.join(',')
      )}&lang=${t}`,
      {
        signal: i
  ...
  x = ({ serverURL: e, lang: t, path: n, type: r, action: i }) =>
    fetch(`${e}/article?lang=${t}`, {
      method: 'POST',
      headers: w,
      body: JSON.stringify({ path: n, type: r, action: i })
    }).then((e) => e.json()),
  _ = ({ serverURL: e, lang: t, token: n, objectId: r, ...i }) =>
...
const H = (e) =>
    ae(e)
      ...
      : null == e
      ? ''
      : re(e) || (ue(e) && (e.toString === de || !se(e.toString)))
...
function Ze(e, t) {
  let n = !1
  Te <= 30 ? Oe(e) || ((e.n |= Pe), (n = !ze(e))) : (n = !e.has(Ue)),
...
function it(e = !1, t = !1) {
  return function (n, r, i) {
    ...
    return (ce(r) ? Ye.has(r) : Je(r))
      ? o
      : (e || qe(n, 0, r),
        t ? o : Gt(o) ? (l && ge(r) ? o : o.value) : ue(o) ? (e ? Pt(o) : Tt(o)) : o)
  }
}
...
function lt(e = !1) {
  return function (t, n, r, i) {
    ...
    if (!e && (Ft(r) || Nt(r) || ((l = Vt(l)), (r = Vt(r))), !re(t) && Gt(l) && !Gt(r)))
      return (l.value = r), !0
...
const ot = {
  ...
  st = { get: tt, set: (e, t) => !0, deleteProperty: (e, t) => !0 },
  at = X({}, ot, { get: et, set: lt(!0) }),
  ct = (e) => e,
...
function $t(e, t) {
  ...
  return (t, r, i) =>
    '__v_isReactive' === r
      ...
      : '__v_raw' === r
      ? t
      : Reflect.get(ne(n, r) && r in t ? n : t, r, i)
}
...
class Yt {
  ...
  set value(e) {
    ...
    ;(e = t ? e : Vt(e)),
      Ce(e, this._rawValue) && ((this._rawValue = e), (this._value = t ? e : Ht(e)), Zt(this))
  }
}
...
class rn {
  ...
  get value() {
    const e = Vt(this)
    return (
      qt(e), (!e._dirty && e._cacheable) || ((e._dirty = !1), (e._value = e.effect.run())), e._value
    )
  }
...
function yn(e) {
  ;(un.length && un.includes(e, an && e.allowRecurse ? pn + 1 : pn)) ||
    (null == e.id
      ? un.push(e)
      : un.splice(
          (function (e) {
...
function $n(e, t, n = !1) {
  ...
  let o = {}
  return l
    ? (re(l) ? l.forEach((e) => (o[e] = null)) : X(o, l), ue(e) && r.set(e, o), o)
...
function In(e, t) {
  return (
    ...
    ne(e, t[0].toLowerCase() + t.slice(1)) || ne(e, ke(t)) || ne(e, t))
  )
}
...
function An(e) {
  ...
  try {
    if (4 & n.shapeFlag) {
      ...
      const e = t
      ;(m = qr(e.length > 1 ? e(l, { attrs: a, slots: s, emit: c }) : e(l, null))),
        (v = t.props ? a : zn(a))
    }
  } catch (t) {
  ...
  return (
    n.dirs && ((w = Br(w)), (w.dirs = w.dirs ? w.dirs.concat(n.dirs) : n.dirs)),
...
function Nn(e, t, { immediate: n, deep: r, flush: i, onTrack: l, onTrigger: o } = q) {
  ...
  if (
    (Gt(e)
      ...
      : re(e)
      ? ((p = !0),
        (u = e.some((e) => Mt(e) || Ft(e))),
        (a = () => e.map((e) => (Gt(e) ? e.value : Mt(e) ? Fn(e) : se(e) ? ln(e, s, 2) : void 0))))
      : (a = se(e)
          ? t
            ? () => ln(e, s, 2)
            : () => {
  ...
  const g = () => {
    if (v.active)
      if (t) {
        const e = v.run()
        ;(r || u || (p ? e.some((e, t) => Ce(e, f[t])) : Ce(e, f))) &&
          (c && c(), on(t, s, 3, [e, f === Un ? void 0 : p && f[0] === Un ? [] : f, h]), (f = e))
      } else v.run()
  }
  let m
  ;(g.allowRecurse = !!t),
...
function Fn(e, t) {
  ...
  if ((t.add(e), Gt(e))) Fn(e.value, t)
  else if (re(e)) for (let n = 0; n < e.length; n++) Fn(e[n], t)
  else if (le(e) || ie(e))
    e.forEach((e) => {
      Fn(e, t)
    })
  ...
  nr = {
    get({ _: e }, t) {
      ...
      return u
        ...
        : n !== q && ne(n, t)
        ? ((o[t] = 4), n[t])
        : ((d = a.config.globalProperties), ne(d, t) ? d[t] : void 0)
    },
    set({ _: e }, t, n) {
      ...
      return tr(i, t)
        ...
        : r !== q && ne(r, t)
        ? ((r[t] = n), !0)
        : !ne(e.props, t) && ('$' !== t[0] || !(t.slice(1) in e)) && ((l[t] = n), !0)
    },
    has(
      ...
      return (
        ...
        ne(r, o) ||
        ne(er, o) ||
        ne(i.config.globalProperties, o)
      )
    },
...
function rr(e, t, n, r = !1) {
  ...
  n ? (e.props = r ? i : Ut(i, !1, at, Et, At)) : e.type.props ? (e.props = i) : (e.props = l),
    (e.attrs = l)
}
    ...
    for (let a in t) {
      ...
      i && ne(i, (u = we(a)))
        ? l && l.includes(u)
          ? ((o || (o = {}))[u] = c)
          : (n[u] = c)
        : In(e.emitsOptions, a) || (a in r && c === r[a]) || ((r[a] = c), (s = !0))
    }
  if (l) {
    const t = Vt(n),
      r = o || q
...
function or(e, t, n = !1) {
  ...
  if (re(l))
    ...
    for (const e in l) {
      ...
      if (sr(t)) {
        const n = l[e],
          r = (o[t] = re(n) || se(n) ? { type: n } : Object.assign({}, n))
        if (r) {
...
function yr(e, t) {
  return function (n, r = null) {
    ...
    const s = (i.app = {
      ...
      use: (e, ...t) => (
        l.has(e) ||
          (e && se(e.install) ? (l.add(e), e.install(s, ...t)) : se(e) && (l.add(e), e(s, ...t))),
        s
      ),
      mixin: (e) => s,
...
function wr(e, t, n, r, i = !1) {
  ...
  if (
    (null != c &&
      c !== a &&
      (ae(c) ? ((u[c] = null), ne(p, c) && (p[c] = null)) : Gt(c) && (c.value = null)),
    se(a))
  )
    ln(a, s, 12, [o, u])
  else {
...
const br = function (e, t) {
  ...
  t && t.pendingBranch
    ...
    : (re((n = e))
        ? dn.push(...n)
        : (hn && hn.includes(n, n.allowRecurse ? fn + 1 : fn)) || dn.push(n),
      wn())
}
...
function kr(e) {
  return (function (e, t) {
    ...
    const {
      ...
      f = (e, t, n, r = null, i = null, l = null, o = !1, s = null, a = !!t.dynamicChildren) => {
        if (e === t) return
        e && !Ur(e, t) && ((r = V(e)), U(e, i, l, !0), (e = null)),
        ...
        switch (c) {
          ...
          default:
            1 & p
              ...
              : 6 & p
              ? E(e, t, n, r, i, l, o, s, a)
              : (64 & p || 128 & p) && c.process(e, t, n, r, i, l, o, s, a, H)
        }
      ...
      k = (e, t, r, o, s, a, u, p) => {
        ...
        if (
          ...
          8 & m
            ? c(d, e.children)
            : 16 & m && _(e.children, d, null, o, s, a && 'foreignObject' !== f, u, p),
          y && Gn(e, null, o, 'created'),
          g)
        ) {
      ...
      C = (e, t, n, r, l, o, s) => {
        ...
        let g
        n && xr(n, !1),
          (g = f.onVnodeBeforeUpdate) && Kr(g, n, t, e),
          d && Gn(t, e, n, 'beforeUpdate'),
          n && xr(n, !0)
        const m = l && 'foreignObject' !== t.type
        if (
          (p ? S(e.dynamicChildren, p, a, n, r, m, o) : s || O(e, t, a, null, n, r, m, o, !1),
          u > 0)
        ) {
          if (16 & u) $(a, t, h, f, n, r, l)
          else if (
            (2 & u && h.class !== f.class && i(a, 'class', null, f.class, l),
            4 & u && i(a, 'style', h.style, f.style, l),
            8 & u)
          ) {
      ...
      $ = (e, t, n, r, l, o, s) => {
        if (n !== r) {
          if (n !== q)
            for (const a in n) me(a) || a in r || i(e, a, n[a], null, s, t.children, l, o, D)
          for (const a in r) {
            if (me(a)) continue
            const c = r[a],
              u = n[a]
      ...
      I = (e, t, r, i, l, s, a, c, u) => {
        ...
        g && (c = c ? c.concat(g) : g),
          null == e
            ? (n(p, r, i), n(d, r, i), _(t.children, r, d, l, s, a, c, u))
            : h > 0 && 64 & h && f && e.dynamicChildren
            ? (S(e.dynamicChildren, f, r, l, s, a, c),
              (null != t.key || (l && t === l.subTree)) && _r(e, t, !0))
            : O(e, t, r, d, l, s, a, c, u)
      },
      E = (e, t, n, r, i, l, o, s, a) => {
        ;(t.slotScopeIds = s),
      ...
      R = (e, t, n, r, i, l, o) => {
        const s = (e.component = (function (e, t, n) {
          ...
          ;(l.ctx = { _: l }),
            (l.root = t ? t.root : l),
            (l.emit = Sn.bind(null, l)),
            e.ce && e.ce(l)
          return l
        })(e, r, i))
        if (
          (e.type.__isKeepAlive && (s.ctx.renderer = H),
          (function (e, t = !1) {
            ni = t
      ...
      L = (e, t, n) => {
        ...
        if (
          (function (e, t, n) {
            ...
            if (!(n && a >= 0))
              return !((!i && !s) || (s && s.$stable)) || (r !== o && (r ? !o || jn(r, o, c) : !!o))
            if (1024 & a) return !0
        ...
        const s = () => {
            if (e.isMounted) {
              ...
              xr(e, !1),
                ...
                r && Se(r),
                (t = n.props && n.props.onVnodeBeforeUpdate) && Kr(t, a, n, c),
                xr(e, !0)
              const d = An(e),
                h = e.subTree
              ;(e.subTree = d),
                f(h, d, u(h.el), V(h), e, i, l),
                (n.el = d.el),
                null === p &&
                ...
                s && br(s, i),
                (t = n.props && n.props.onVnodeUpdated) && br(() => Kr(t, a, n, c), i)
            } else {
              let o
              ...
              if (
                (xr(e, !1),
                c && Se(c),
                !d && (o = a && a.onVnodeBeforeMount) && Kr(o, p, t),
                xr(e, !0),
                s && K)
              ) {
                const n = () => {
              ...
              ;(256 & t.shapeFlag || (p && Vn(p.vnode) && 256 & p.vnode.shapeFlag)) &&
                e.a &&
                br(e.a, i),
                (e.isMounted = !0),
                (t = n = r = null)
        ...
        ;(e.vnode = t),
          ...
          (function (e, t, n, r) {
            ...
            if (!(r || o > 0) || 16 & o) {
              ...
              ir(e, t, i, l) && (c = !0)
              for (const l in s)
                (t && (ne(t, l) || ((r = ke(l)) !== l && ne(t, r)))) ||
                  (a
                    ? !n ||
                      (void 0 === n[l] && void 0 === n[r]) ||
                      (i[l] = lr(a, s, l, void 0, e, !0))
                    : delete i[l])
      ...
      O = (e, t, n, r, i, l, o, s, a = !1) => {
        ...
        8 & f
          ? (16 & p && D(u, i, l), d !== u && c(n, d))
          : 16 & p
          ? 16 & f
            ? T(u, d, n, r, i, l, o, s, a)
            : D(u, i, l, !0)
          : (8 & p && c(n, ''), 16 & f && _(d, n, r, i, l, o, s, a))
      },
      j = (e, t, n, r, i, l, o, s, a) => {
        t = t || Z
      ...
      T = (e, t, n, r, i, l, o, s, a) => {
        ...
        if (c > p) {
        ...
        } else if (c > d) for (; c <= p; ) U(e[c], i, l, !0), c++
        else {
          const h = c,
            g = c,
            m = new Map()
          ...
          for (v = _.length - 1, c = w - 1; c >= 0; c--) {
            const e = g + c,
              ...
              d = e + 1 < u ? t[e + 1].el : r
            0 === x[c]
              ? f(null, p, n, d, i, l, o, s, a)
              : b && (v < 0 || c !== _[v] ? P(p, n, d, 2) : v--)
          }
        }
      },
      P = (e, t, r, i, l = null) => {
        ...
        if (2 !== i && 1 & u && a)
          if (0 === i) a.beforeEnter(o), n(o, t, r), br(() => a.enter(o), l)
          else {
            const { leave: e, delayLeave: i, afterLeave: l } = a,
              s = () => n(o, t, r),
              c = () => {
                e(o, () => {
                  s(), l && l()
      ...
      U = (e, t, n, r = !1, i = !1) => {
        ...
        const h = 1 & u && d,
          f = !Vn(e)
        let g
        if ((f && (g = o && o.onVnodeBeforeUnmount) && Kr(g, t, e), 6 & u)) F(e.component, n, r)
        else {
          if (128 & u) return void e.suspense.unmount(n, r)
          h && Gn(e, null, t, 'beforeUnmount'),
            64 & u
              ? e.type.remove(e, t, n, i, H, r)
              : c && (l !== Cr || (p > 0 && 64 & p))
              ? D(c, t, n, !1, !0)
              : ((l === Cr && 384 & p) || (!i && 16 & u)) && D(a, t, n),
            r && M(e)
        }
...
function _r(e, t, n = !1) {
  ...
  if (re(r) && re(i))
    for (let e = 0; e < r.length; e++) {
      ...
      1 & l.shapeFlag &&
        !l.dynamicChildren &&
        ((l.patchFlag <= 0 || 32 === l.patchFlag) && ((l = i[e] = Zr(i[e])), (l.el = t.el)),
        n || _r(t, l)),
        l.type === Sr && (l.el = t.el)
    }
}
...
function Or(e) {
  return (
    (e.dynamicChildren = Ar > 0 ? Rr || Z : null),
    Er.pop(),
...
function Dr(e, t = null, n = null, r = 0, i = null, l = e === Cr ? 0 : 1, o = !1, s = !1) {
  ...
  return (
    s ? (Gr(a, n), 128 & l && e.normalize(a)) : n && (a.shapeFlag |= ae(n) ? 8 : 16),
    Ar > 0 && !o && Rr && (a.patchFlag > 0 || 6 & l) && 32 !== a.patchFlag && Rr.push(a),
    a
  )
}
...
const Vr = function (e, t = null, n = null, r = 0, i = null, l = !1) {
  ...
  if (Pr(e)) {
    ...
    return (
      n && Gr(r, n),
      Ar > 0 && !l && Rr && (6 & r.shapeFlag ? (Rr[Rr.indexOf(e)] = r) : Rr.push(r)),
      (r.patchFlag |= -2),
      r
    )
  }
...
function Br(e, t, n = !1) {
  const { props: r, ref: i, patchFlag: l, children: o } = e,
    s = t
      ? (function (...e) {
          const t = {}
          for (let n = 0; n < e.length; n++) {
            const r = e[n]
            for (const e in r)
              if ('class' === e) t.class !== r.class && (t.class = N([t.class, r.class]))
              else if ('style' === e) t.style = j([t.style, r.style])
              else if (J(e)) {
                const n = t[e],
                  i = r[e]
...
function Gr(e, t) {
  ...
  if (null == t) t = null
    ...
    }
    {
      ...
      const r = t._
      r || Mr in t
        ? 3 === r && En && (1 === En.slots._ ? (t._ = 1) : ((t._ = 2), (e.patchFlag |= 1024)))
        : (t._ctx = En)
    }
  } else
    se(t)
...
function li(e) {
  if (e.exposed)
    return (
      e.exposeProxy ||
      (e.exposeProxy = new Proxy(tn(Bt(e.exposed)), {
  ...
  return 2 === r
    ? ue(t) && !re(t)
      ? Pr(t)
        ...
        : Vr(e, t)
      : Vr(e, null, t)
    : (r > 3 ? (n = Array.prototype.slice.call(arguments, 2)) : 3 === r && Pr(n) && (n = [n]),
      Vr(e, t, n))
}
  ...
  hi = {
    ...
    createElement: (e, t, n, r) => {
      const i = t
        ...
        : pi.createElement(e, n ? { is: n } : void 0)
  ...
  if (r && o) o.value = r
    ...
    if (r) {
      const o = (l[t] = (function (e, t) {
        ...
        return (
          (n.value = e),
          (n.attached = (() => xi || (_i.then(() => (xi = 0)), (xi = Date.now())))()),
          n
        )
      })(r, i))
      wi(e, n, o, s)
...
function Li(e, { value: t, oldValue: n }, r) {
  ;(e._modelValue = t),
    re(t)
      ? (e.checked = B(t, r.props.value) > -1)
      : le(t)
      ? (e.checked = t.has(r.props.value))
      : t !== n && (e.checked = V(t, Ti(e, !0)))
}
...
function Oi(e, t) {
  ...
  if (!n || re(t) || le(t)) {
    for (let r = 0, i = e.options.length; r < i; r++) {
      const i = e.options[r],
        l = ji(i)
      if (n) re(t) ? (i.selected = B(t, l) > -1) : (i.selected = t.has(l))
      else if (V(ji(i), t)) return void (e.selectedIndex !== r && (e.selectedIndex = r))
    }
      ...
      'class' === t
        ...
        : (
            '.' === t[0]
              ...
              : (function (e, t, n, r) {
                  if (r)
                    return (
                      'innerHTML' === t || 'textContent' === t || !!(t in e && Ci.test(t) && se(n))
                    )
        ...
        ? (function (e, t, n, r, i, l, o) {
            if ('innerHTML' === t || 'textContent' === t)
              return r && o(r, i, l), void (e[t] = null == n ? '' : n)
        ...
        : ('true-value' === t ? (e._trueValue = r) : 'false-value' === t && (e._falseValue = r),
          (function (e, t, n, r, i) {
            if (r && t.startsWith('xlink:'))
              null == n ? e.removeAttributeNS(yi, t.slice(6, t.length)) : e.setAttributeNS(yi, t, n)
            else {
              const r = F(t)
...
let Di
const Vi = (...e) => {
  const t = (Di || (Di = kr(Fi))).createApp(...e),
    { mount: n } = t
  return (
    (t.mount = (e) => {
      const r = (function (e) {
...
Hi &&
  (null == (Bi = null == window ? void 0 : window.navigator) ? void 0 : Bi.userAgent) &&
  ...
  return Zi(
    (function (e, t = {}) {
      ...
      return (i) => {
        const l = qi(e),
          o = qi(t.maxWait)
        if ((n && clearTimeout(n), l <= 0 || (void 0 !== o && o <= 0)))
...
var nl = Object.defineProperty,
  ...
  al = (e, t, n) =>
    t in e ? nl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)
...
var ml = Object.defineProperty,
  ...
  bl = (e, t, n) =>
    t in e ? ml(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
  kl = (e, t) => {
...
var Cl,
  ...
  Ll = (e, t, n) =>
    t in e ? $l(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)
  ...
  const { controls: t = !1, interval: n = 'requestAnimationFrame' } = e,
    ...
    l =
      'requestAnimationFrame' === n
        ? (function (e, t = {}) {
            const { immediate: n = !0, window: r = ul } = t,
              i = Kt(!1)
            let l = null
...
var Ol = Object.defineProperty,
  ...
  Ul = (e, t, n) =>
    t in e ? Ol(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)
;((e, t) => {
...
class yo {
    ...
    if (t) {
      ...
      if (e.header.length === e.align.length) {
        ...
        for (o = e.rows.length, n = 0; n < o; n++)
          e.rows[n] = ho(e.rows[n], e.header.length).map((e) => ({ text: e }))
        for (o = e.header.length, r = 0; r < o; r++)
          e.header[r].tokens = this.lexer.inline(e.header[r].text)
        for (o = e.rows.length, r = 0; r < o; r++)
          for (l = e.rows[r], i = 0; i < l.length; i++) l[i].tokens = this.lexer.inline(l[i].text)
        return e
      }
    }
  }
  ...
  autolink(e, t) {
    ...
    if (n) {
      ...
      return (
        '@' === n[2]
          ? ((e = Yl(this.options.mangle ? t(n[1]) : n[1])), (r = 'mailto:' + e))
          : ((e = Yl(n[1])), (r = e)),
        {
          type: 'link',
          raw: n[0],
  ...
  url(e, t) {
    ...
    if ((n = this.rules.inline.url.exec(e))) {
      let e, r
      if ('@' === n[2]) (e = Yl(this.options.mangle ? t(n[0]) : n[0])), (r = 'mailto:' + e)
      else {
        let t
        do {
        ...
        (e = this.lexer.state.inRawBlock
          ? this.options.sanitize
            ? this.options.sanitizer
              ...
              : Yl(n[0])
            : n[0]
          : Yl(this.options.smartypants ? t(n[0]) : n[0])),
        {
          type: 'text',
          raw: n[0],
          text: e
...
;(wo.def = no(wo.def).replace('label', wo._label).replace('title', wo._title).getRegex()),
  (wo.bullet = /(?:[*+-]|\d{1,9}[.)])/),
  (wo.listItemStart = no(/^( *)(bull) */)
  ...
  (wo.paragraph = no(wo._paragraph)
    ...
    .replace('tag', wo._tag)
    .getRegex()),
  (wo.blockquote = no(wo.blockquote).replace('paragraph', wo.paragraph).getRegex()),
  (wo.normal = po({}, wo)),
  (wo.gfm = po({}, wo.normal, {
    table:
      '^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)'
  })),
  (wo.gfm.table = no(wo.gfm.table)
    .replace('hr', wo.hr)
    .replace('heading', ' {0,3}#{1,6} ')
    .replace('blockquote', ' {0,3}>')
    .replace('code', ' {4}[^\\n]')
    ...
    .replace('tag', wo._tag)
    .getRegex()),
  (wo.gfm.paragraph = no(wo._paragraph)
    .replace('hr', wo.hr)
    .replace('heading', ' {0,3}#{1,6} ')
    .replace('|lheading', '')
    .replace('table', wo.gfm.table)
    .replace('blockquote', ' {0,3}>')
    .replace('fences', ' {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n')
    .replace('list', ' {0,3}(?:[*+-]|1[.)]) ')
    .replace('html', '</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)')
  ...
  (wo.pedantic = po({}, wo.normal, {
    ...
    heading: /^(#{1,6})(.*)(?:\n+|$)/,
    fences: uo,
    paragraph: no(wo.normal._paragraph)
      .replace('hr', wo.hr)
      .replace('heading', ' *#{1,6} *[^\n]')
...
;(bo._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
  (bo.punctuation = no(bo.punctuation)
    .replace(/punctuation/g, bo._punctuation)
    .getRegex()),
  (bo.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
  (bo.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
  (bo._comment = no(wo._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
  (bo.emStrong.lDelim = no(bo.emStrong.lDelim).replace(/punct/g, bo._punctuation).getRegex()),
  (bo.emStrong.rDelimAst = no(bo.emStrong.rDelimAst, 'g')
    .replace(/punct/g, bo._punctuation)
    .getRegex()),
  (bo.emStrong.rDelimUnd = no(bo.emStrong.rDelimUnd, 'g')
    .replace(/punct/g, bo._punctuation)
    .getRegex()),
  (bo._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
  (bo._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
  (bo._email =
    /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
  (bo.autolink = no(bo.autolink)
    .replace('scheme', bo._scheme)
    .replace('email', bo._email)
    .getRegex()),
  (bo._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (bo.tag = no(bo.tag)
    .replace('comment', bo._comment)
    .replace('attribute', bo._attribute)
    .getRegex()),
  (bo._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
  (bo._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
  (bo._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  (bo.link = no(bo.link)
    .replace('label', bo._label)
    .replace('href', bo._href)
    .replace('title', bo._title)
    .getRegex()),
  (bo.reflink = no(bo.reflink).replace('label', bo._label).replace('ref', wo._label).getRegex()),
  (bo.nolink = no(bo.nolink).replace('ref', wo._label).getRegex()),
  (bo.reflinkSearch = no(bo.reflinkSearch, 'g')
    .replace('reflink', bo.reflink)
    .replace('nolink', bo.nolink)
    .getRegex()),
  (bo.normal = po({}, bo)),
  (bo.pedantic = po({}, bo.normal, {
    strong: {
      start: /^__|\*\*/,
  ...
  (bo.gfm.url = no(bo.gfm.url, 'i').replace('email', bo.gfm._extended_email).getRegex()),
  (bo.breaks = po({}, bo.gfm, {
...
class _o {
  constructor(e) {
    ;(this.tokens = []),
      ...
      (this.options = e || Wl),
      (this.options.tokenizer = this.options.tokenizer || new yo()),
    ...
    this.options.pedantic
      ? ((t.block = wo.pedantic), (t.inline = bo.pedantic))
      : this.options.gfm &&
        ((t.block = wo.gfm), this.options.breaks ? (t.inline = bo.breaks) : (t.inline = bo.gfm)),
  ...
  inlineTokens(e, t = []) {
    ...
    for (; e; )
      if (
        ...
        if ((n = this.tokenizer.escape(e))) (e = e.substring(n.raw.length)), t.push(n)
          ...
          (e = e.substring(n.raw.length)),
            ...
            r && 'text' === n.type && 'text' === r.type
              ? ((r.raw += n.raw), (r.text += n.text))
              : t.push(n)
        else if ((n = this.tokenizer.emStrong(e, a, s))) (e = e.substring(n.raw.length)), t.push(n)
        ...
        else if ((n = this.tokenizer.autolink(e, xo))) (e = e.substring(n.raw.length)), t.push(n)
        else if (this.state.inLink || !(n = this.tokenizer.url(e, xo))) {
          ...
          if ((n = this.tokenizer.inlineText(i, ko)))
            (e = e.substring(n.raw.length)),
    ...
    for (n = 0; n < x; n++)
      if (
        ...
        this.options.extensions &&
          ...
          ((b = this.options.extensions.renderers[p.type].call({ parser: this }, p)),
          !1 !== b ||
            ![
              'space',
              'hr',
        ...
        switch (p.type) {
          ...
          case 'heading':
            k += this.renderer.heading(
              ...
              p.depth,
              eo(this.parseInline(p.tokens, this.textRenderer)),
              this.slugger
            )
            continue
          case 'code':
            ...
            continue
          case 'table':
            for (c = '', a = '', l = p.header.length, r = 0; r < l; r++)
              a += this.renderer.tablecell(this.parseInline(p.header[r].tokens), {
                header: !0,
                align: p.align[r]
              })
            for (c += this.renderer.tablerow(a), u = '', l = p.rows.length, r = 0; r < l; r++) {
              for (s = p.rows[r], a = '', o = s.length, i = 0; i < o; i++)
                a += this.renderer.tablecell(this.parseInline(s[i].tokens), {
                  header: !1,
                  align: p.align[i]
                })
          ...
          case 'list':
            for (
              d = p.ordered, h = p.start, f = p.loose, l = p.items.length, u = '', r = 0;
              r < l;
              r++
            )
              (m = p.items[r]),
...
function Eo(e, t, n) {
  ...
  if (
    ('function' == typeof t && ((n = t), (t = null)), go((t = po({}, Eo.defaults, t || {}))), n)
  ) {
    const r = t.highlight
    let i
    try {
  ...
  function r(e) {
    if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
      return '<p>An error occurred:</p><pre>' + Yl(e.message + '', !0) + '</pre>'
    throw e
  }
  ...
  try {
    ...
    if (t.walkTokens) {
      if (t.async)
        return Promise.all(Eo.walkTokens(n, t.walkTokens))
          .then(() => Io.parse(n, t))
          .catch(r)
...
;(Eo.options = Eo.setOptions =
  ...
  (Eo.use = function (...e) {
    const t = po({}, ...e),
      n = Eo.defaults.extensions || { renderers: {}, childTokens: {} }
    let r
    e.forEach((e) => {
      if (
        (e.extensions &&
  ...
  (Eo.walkTokens = function (e, t) {
    let n = []
    for (const r of e)
      switch (((n = n.concat(t.call(Eo, r))), r.type)) {
        case 'table':
        ...
        case 'list':
          ...
          break
        default:
          Eo.defaults.extensions &&
          Eo.defaults.extensions.childTokens &&
          Eo.defaults.extensions.childTokens[r.type]
            ? Eo.defaults.extensions.childTokens[r.type].forEach(function (e) {
...
const Ro = /\$.*?\$/,
  ...
  Ao = /^(?:\s{0,3})\$\$((?:[^\n]|\n[^\n])+?)\n{0,1}\$\$/,
  zo = (e = '', t = {}) =>
    e.replace(/:(.+?):/g, (e, n) => (t[n] ? `<img class="wl-emoji" src="${t[n]}" alt="${n}">` : e)),
  Oo = (e, { emojiMap: t, highlighter: n, texRenderer: r }) => {
    if (
      (Eo.setOptions({ highlight: n || void 0, breaks: !0, smartLists: !0, smartypants: !0 }), r)
    ) {
      const e = ((e) => [
        {
          name: 'blockMath',
...
var Zo = (function () {
  ...
  return (
    (e.load = function (t, n) {
      ...
      if (e.getLoadingState() === Wo.LOADED)
      ...
      if (e.getLoadingState() === Wo.LOADING)
    ...
    setup() {
      ...
      return (
              ...
              ;(() => {
                ...
                if (o.length) {
                  ...
                  k({
                    ...
                    Array.isArray(t) ||
                      'number' == typeof t ||
                      (e.value = o.map((e, n) => t[`reaction${n}`]))
                  }),
                    (l = n.abort.bind(n))
                }
              })()
        ...
        qn(() => l?.()),
        {
          ...
          locale: r,
          vote: async (r) => {
            const { serverURL: i, lang: l, path: o } = n.value,
              s = t.value.find(({ id: e }) => e === o)
            ;(s && s.i === r) ||
              (await x({
                serverURL: i,
                lang: l,
              ...
              (e.value[r] = (e.value[r] || 0) + 1),
              s
                ? ((e.value[s.i] = Math.max(e.value[s.i] - 1, 0)),
                  x({
                    serverURL: i,
                    lang: l,
                    path: o,
...
const ts = { key: 0, class: 'wl-reaction' },
  ns = ['textContent'],
  rs = ['onClick'],
  is = { class: 'wl-reaction-img' },
  ls = ['src', 'alt'],
  os = { class: 'wl-reaction-votes' },
  ss = { class: 'wl-reaction-text' }
var as,
  cs,
  us = es(Xo, [
    [
      ...
      function (e, t, n, r, i, l) {
        return e.reaction.length
          ? (Lr(),
            jr('div', ts, [
              Dr('h4', { textContent: H(e.locale.reactionTitle) }, null, 8, ns),
              Dr('ul', null, [
                (Lr(!0),
                jr(
                  Cr,
                      ...
                      jr(
                        ...
                        [
                          Dr('div', is, [
                            ...
                            Dr('div', os, H(t.vote), 1)
                          ]),
                          Dr('div', ss, H(t.desc), 1)
                        ],
                        10,
                        rs
                      )
  ...
  setup(e) {
    ...
    const n = Kt(null),
      ...
      o = async (t) => {
        ...
        await vn()
        const r = Array.from(n.value?.children || []).reduce((e, t) =>
...
var ks = Dn({
                                  ...
                                  [
                                    ...
                                    Dr(
                                      'img',
                                      {
                                        ...
                                        onLoad:
                                          t[0] ||
                                          (t[0] = (...t) => e.imageLoad && e.imageLoad(...t)),
  ...
  setup(e, { emit: t }) {
    const n = Tn('config'),
      ...
      i = _l('WALINE_USER_META', { nick: '', mail: '', link: '' }),
      l = Yo(),
      o = Kt({}),
      s = Kt(null),
      a = Kt(null),
      ...
      A = (e) => {
        const t = s.value,
          ...
          i = t.selectionEnd || 0,
          l = t.scrollTop
        ;(r.value = t.value.substring(0, n) + e + t.value.substring(i, t.value.length)),
          t.focus(),
      ...
      O = async () => {
        ...
        if (l.value?.token)
          (g.nick = l.value.display_name), (g.mail = l.value.email), (g.link = l.value.url)
        else {
          if ('force' === u) return
          if (d.indexOf('nick') > -1 && !g.nick)
            return o.value.nick?.focus(), alert(E.value.nickError)
          if (
            (d.indexOf('mail') > -1 && !g.mail) ||
            (g.mail && !/^\w(?:[\w._-]*\w)?@(?:\w(?:[\w-]*\w)?\.)*\w+$/.exec(g.mail))
          )
            return o.value.mail?.focus(), alert(E.value.mailError)
        ...
        ;(g.comment = zo(g.comment, f.value.map)),
          e.replyId && e.rootId && ((g.pid = e.replyId), (g.rid = e.rootId), (g.at = e.replyUser)),
          (I.value = !0)
        const m = { serverURL: a, lang: c, token: l.value?.token, comment: g }
        ;(e.edit
          ? _({ objectId: e.edit.objectId, ...m })
      ...
      j = (e) => {
        c.value.contains(e.target) || u.value.contains(e.target) || (m.value = !1),
          p.value.contains(e.target) || d.value.contains(e.target) || (v.value = !1)
      },
      T = async (e) => {
        const { scrollTop: t, clientHeight: r, scrollHeight: i } = e.target,
          l = (r + t) / i,
          o = n.value.search,
          s = h.value?.value || ''
        l < 0.9 ||
          ...
          (k.list = [
            ...k.list,
            ...(o.more && k.list.length ? await o.more(s, k.list.length) : await o.search(s))
          ]),
          (k.loading = !1),
          setTimeout(() => {
    ...
    Mn(
      ...
      ([e, t]) => {
        ...
        n
          ? t < n[0] && 0 !== n[0]
            ? ((x.value = n[0]), (C.value = !1))
            : t > n[1]
            ? ((x.value = n[1]), (C.value = !1))
            : ((x.value = n[1]), (C.value = !0))
          : ((x.value = 0), (C.value = !0))
      },
      { immediate: !0 }
    )
    ...
    return (
      Hn(() => {
        document.body.addEventListener('click', j),
          ...
          e.edit?.objectId && (r.value = e.edit.orig),
          Mn(v, async (e) => {
            if (!e) return
            const t = n.value.search
            h.value && (h.value.value = ''),
              (k.loading = !0),
              (k.list = t.default ? await t.default() : await t.search('')),
              (k.loading = !1)
          }),
          Mn(
            () => r.value,
            (e) => {
              ...
              ;($.value = e),
                ...
                e ? ms(s.value) : ms.destroy(s.value)
            },
            { immediate: !0 }
          ),
          Mn(
            ...
            (e) => {
              ...
              Promise.all(
                t.map((e) => ('string' == typeof e ? Ml(S(e)) : Promise.resolve(e)))
              ).then((e) => {
                const t = { tabs: [], map: {} }
                return (
                  e.forEach((e) => {
              ...
              new Promise((e) => {
                const t = ({ data: n }) => {
                  n &&
                    ...
                    'userInfo' === n.type &&
                    n.data.token &&
                    (i?.close(), window.removeEventListener('message', t), e(n.data))
                }
        ...
        onProfile: (e) => {
          ...
          window
            .open(
              ...
              '_blank',
              `width=800,height=800,left=${i},top=${o},scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no`
            )
            ?.postMessage(
              {
                type: 'TOKEN',
...
const xs = { class: 'wl-comment' },
  _s = { key: 0, class: 'wl-login-info' },
  Cs = { class: 'wl-avatar' },
  Ss = ['title'],
  $s = ['title'],
  Is = ['src'],
  ...
  Vs = ['title'],
  Bs = { class: 'wl-info' },
  Hs = { class: 'wl-text-number' },
  Ws = { key: 0 },
  qs = ['textContent'],
  Zs = ['textContent'],
  Gs = ['disabled'],
  Ks = ['placeholder'],
  Qs = { key: 0, class: 'wl-loading' },
  Js = { key: 0, class: 'wl-tab-wrapper' },
  Ys = ['title', 'onClick'],
  Xs = ['src', 'alt'],
  ea = { key: 0, class: 'wl-tabs' },
  ta = ['onClick'],
  na = ['src', 'alt', 'title'],
  ra = ['title']
var ia = es(ks, [
  [
    ...
    function (e, t, n, r, i, l) {
      ...
      return (
        Lr(),
        jr('div', xs, [
          'disable' !== e.config.login && e.isLogin && !e.edit?.objectId
            ? (Lr(),
              jr('div', _s, [
                Dr('div', Cs, [
                  Dr(
                  ...
                  Dr(
                    ...
                    [Dr('img', { src: e.userInfo.avatar, alt: 'avatar' }, null, 8, Is)],
                    8,
                    $s
                  )
                ]),
          ...
          Dr('div', Rs, [
            ...
            Zn(
              Dr(
                ...
                [
                  js,
                  Dr('h4', null, H(e.locale.preview) + ':', 1),
                  Wr(' eslint-disable-next-line vue/no-v-html '),
                  Dr(
                    'div',
                    {
                      class: 'wl-content',
            ...
            Dr('div', Ps, [
                  ...
                  ? (Lr(),
                    jr(
                      'button',
                      {
                        ...
                        onClick:
                          t[12] || (t[12] = (...t) => e.submitComment && e.submitComment(...t))
                      },
                      [
                        e.isSubmitting
                          ? (Lr(),
                          ...
                          : (Lr(), jr(Cr, { key: 1 }, [Hr(H(e.locale.submit), 1)], 64))
                      ],
                      8,
                      Gs
                    ))
              ...
              Dr(
                ...
                [
                  ...
                  e.gifData.loading ? (Lr(), jr('div', Qs, [Vr(d, { size: 30 })])) : Wr('v-if', !0)
                ],
                2
              ),
              Dr(
            ...
            ? (Lr(),
              jr(
                'button',
                {
                  ...
                  onClick:
                    t[15] || (t[15] = (t) => e.$emit(e.replyId ? 'cancel-reply' : 'cancel-edit'))
                },
                [Vr(o, { size: 24 })],
                8,
                ra
...
var oa = Dn({
  components: {
    ...
    LikeIcon: ({ active: e = !1 }) =>
      si('svg', { viewBox: '0 0 1024 1024', width: '24', height: '24' }, [
        si('path', {
          d:
...
const sa = ['id'],
  aa = { class: 'wl-user', 'aria-hidden': 'true' },
  ca = ['src'],
  ua = { class: 'wl-card' },
  pa = { class: 'wl-head' },
  da = ['href'],
  ha = { key: 1, class: 'wl-nick' },
  fa = ['textContent'],
  ga = ['textContent'],
  ma = ['textContent'],
  va = ['textContent'],
  ya = ['textContent'],
  wa = { class: 'wl-comment-actions' },
  ba = ['title'],
  ka = ['textContent'],
  xa = ['title'],
  _a = { class: 'wl-meta', 'aria-hidden': 'true' },
  Ca = ['data-value', 'textContent'],
  Sa = ['data-value', 'textContent'],
  $a = ['data-value', 'textContent'],
  Ia = ['innerHTML'],
  Ea = { key: 1, class: 'wl-admin-actions' },
  Ra = { class: 'wl-comment-status' },
  La = ['disabled', 'onClick', 'textContent'],
  Aa = { key: 3, class: 'wl-quote' }
var za = es(oa, [
  [
    'render',
    function (e, t, n, r, i, l) {
          ...
          [
            Dr('div', aa, [
              e.comment.avatar
                ...
                : Wr('v-if', !0),
              e.comment.type ? (Lr(), Tr(o, { key: 1 })) : Wr('v-if', !0)
            ]),
            Dr('div', ua, [
              Dr('div', pa, [
                e.link
                  ...
                  : (Lr(), jr('span', ha, H(e.comment.nick), 1)),
                  ...
                  ? (Lr(),
                    jr(
                      'span',
                      {
                        ...
                        textContent: H(
                          e.locale[`level${e.comment.level}`] || `Level ${e.comment.level}`
                        )
                      },
                      null,
                      10,
                ...
                Dr('div', wa, [
                  ...
                  Dr(
                    ...
                    [
                      Vr(c, { active: e.like }, null, 8, ['active']),
                      'like' in e.comment
                        ? (Lr(),
                          jr(
                            'span',
                  ...
                  Dr(
                    'button',
                    {
                      ...
                      onClick:
                        t[3] ||
                        (t[3] = (t) => e.$emit('reply', e.isReplyingCurrent ? null : e.comment))
                    },
                    [Vr(u)],
                    10,
                    xa
              ...
              Wr(' eslint-disable vue/no-v-html '),
              e.isEditingCurrent
                ? Wr('v-if', !0)
                : (Lr(),
                  jr(
              ...
              Wr(' eslint-enable vue/no-v-html '),
                    ...
                    e.isAdmin && !e.comment.rid
                      ? (Lr(),
                        jr(
                          ...
                          H(e.comment.sticky ? e.locale.unsticky : e.locale.sticky),
                          1
                        ))
                      : Wr('v-if', !0)
                  ]))
...
const Oa = { latest: 'insertedAt_desc', oldest: 'insertedAt_asc', hottest: 'like_desc' },
  ja = Object.keys(Oa)
var Ta = Dn({
  name: 'WalineRoot',
  ...
  setup(e) {
    const o = e,
      ...
      w = Kt(null),
      k = oi(() => {
        return 'string' == typeof (e = s.value.dark)
          ? 'auto' === e
            ? `@media(prefers-color-scheme:dark){body${L}}`
            : `${e}${L}`
          : !0 === e
          ? `:root${L}`
          : ''
    ...
    const S = (e) => {
        const { serverURL: t, path: n, pageSize: r } = s.value,
            ...
            return (
              ...
              fetch(
                `${e}/comment?path=${encodeURIComponent(
                  n
                )}&pageSize=${i}&page=${r}&lang=${t}&sortBy=${l}`,
                {
                  signal: o,
                  headers: a
                }
    ...
    return (
      ...
      qn(() => x?.()),
      {
        ...
        onSubmit: (e) => {
          if (w.value) (w.value.comment = e.comment), (w.value.orig = e.orig)
          else if (e.rid) {
        ...
        onDelete: async ({ objectId: e }) => {
          ...
          await (({ serverURL: e, lang: t, token: n, objectId: r }) =>
            ...
            m.value.some((t, n) =>
              t.objectId === e
                ? ((m.value = m.value.filter((e, t) => t !== n)), !0)
                : t.children.some(
                    (r, i) =>
                      r.objectId === e &&
                      ((m.value[n].children = t.children.filter((e, t) => t !== i)), !0)
                  )
            )
        },
        onSticky: async (e) => {
        ...
        onLike: async (e) => {
          ...
          await _({
            ...
            i
              ? (u.value = u.value.filter((e) => e !== r))
              : ((u.value = [...u.value, r]),
                u.value.length > 50 && (u.value = u.value.slice(-50))),
...
const Pa = { 'data-waline': '' },
  Ua = { class: 'wl-meta-head' },
  Ma = { class: 'wl-count' },
  Na = ['textContent'],
  Fa = { class: 'wl-sort' },
  Da = ['onClick'],
  Va = { class: 'wl-cards' },
  Ba = { key: 1, class: 'wl-operation' },
  Ha = ['textContent'],
  Wa = { key: 0, class: 'wl-loading' },
  qa = ['textContent'],
  Za = { class: 'wl-operation' },
  Ga = ['textContent'],
  Ka = { key: 3, class: 'wl-power' },
  Qa = Dr(
    'a',
    ...
    function (e, t, n, r, i, l) {
      ...
      return (
        ...
        jr('div', Pa, [
                            ...
                            Dr('div', Za, [
                              Dr(
                                'button',
                                {
                                  ...
                                  class: 'wl-btn',
                                  onClick:
                                    t[1] || (t[1] = (...t) => e.loadMore && e.loadMore(...t)),
          ...
          Wr(' Copyright Information '),
          e.config.copyright
            ? (Lr(), jr('div', Ka, [Hr(' Powered by '), Qa, Hr(' v' + H(e.version), 1)]))
            : Wr('v-if', !0)
        ])
      )
    }
...
const Ya = (e, t) => {
  ...
  Xa = ({
    ...
    if (r) {
      const n = o.filter((e) => !s(e)),
        r = o.filter(s)
      ;((c = { serverURL: I(e), path: t, lang: i }),
      x({
        ...c,
        type: 'time',
        action: 'inc'
      })).then((e) => Ya(new Array(n.length).fill(e), n)),
        r.length && a(r)
    } else a(o)
    var c
  ...
  ec = ({
    ...
    const o = Tt({ ...i }),
      s = Tt({ comment: n, pageview: r, path: t }),
    ...
    return {
      ...
      update: ({ comment: e, pageview: t, path: n = window.location.pathname, ...r } = {}) => {
        Object.entries(r).forEach(([e, t]) => {
          ...
          (s.path = n),
          void 0 !== e && (s.comment = e),
          void 0 !== t && (s.pageview = t)
      },
      destroy: () => {
        a?.unmount(), c(), u()
      }
  ...
  tc = '2.14.1',
  nc = ({ el: e, serverURL: t, count: n, lang: r = 'zh-CN' }) => {
    const i = Yo(),
      l = Dl(e),
    ...
    return (({ serverURL: e, lang: t, count: n, signal: r, token: i }) => {
      ...
      l && e.length
        ? ((l.innerHTML = `<ul class="wl-recent-list">${e
            .map(
              (e) =>
  ...
  rc = ({ el: e, serverURL: t, count: n, locale: r, lang: i = 'zh-CN', mode: l = 'list' }) => {
    ...
    return (({ serverURL: e, signal: t, pageSize: n, lang: r }) =>
      ...
      o && e.length
        ? ((r = { ...(y[i] || y['zh-CN']), ...('object' == typeof r ? r : {}) }),
          (o.innerHTML = `<ul class="wl-user-${l}">${e
            .map((e, t) =>
              [
                ...
                e.nick,
                e.level &&
                  `<span class="wl-badge">${r ? r[`level${e.level}`] : `Level ${e.level}`}</span>`,
