<template>
  <!--  pc-->
  <div v-if="!isShow" v-skeleton.animated="loading" class="home-conter d-flex">
    <div v-if="information" class="introduce">
      <div class="card w-full p-4 bg-base-100 shadow-xl">
        <figure class="px-3">
          <label v-skeleton-item class="swap swap-flip">
            <input type="checkbox" />
            ...
            <div class="swap-on w-32">
              <img v-skeleton-item :src="information.data[0].WeChat" alt="Shoes" class="" />
            </div>
          </label>
        </figure>
        <div class="card-body py-4 items-center text-center">
          <h2 v-skeleton-item class="card-title">
      ...
      <div class="card p-3 d-flex flex-d bg-base-100 mt-5 shadow-xl">
        <div v-skeleton-item class="italic font-semibold">友链</div>
    ...
    <div class="nuggets">
      <div class="card d-flex flex-d bg-base-100 shadow-xl">
        ...
        <div class="p-1 px-3">
          ...
          >
            <h1 v-skeleton-item class="title overflow-omit1 font-normal">
              {{ item.article_info.title }}
            </h1>
            <div v-skeleton-item class="d-flex gap-2 text-gray-600">
